...
function assertEqualsDelta(msg, expected, actual, epsilon) {
  var args = argsWithOptionalMsg_(arguments, 4);
  jstestdriver.assertCount++;
  msg = args[0];
  expected = args[1];
  actual = args[2];
  ...
  if (!compareDelta_(expected, actual, epsilon)) {
      fail(msg + 'expected ' + epsilon + ' within ' +
           prettyPrintEntity_(expected) +
...
if (typeof global != "undefined") {
    global.expectAsserts = expectAsserts;
    global.fail = fail;
    ...
    global.assertNoNull = assertNotNull;
    global.assertUndefined = assertUndefined;
    global.assertNotUndefined = assertNotUndefined;
    global.assertNaN = assertNaN;
    global.assertNotNaN = assertNotNaN;
    global.assertException = assertException;
    global.assertNoException = assertNoException;
    global.assertArray = assertArray;
    global.assertTypeOf = assertTypeOf;
    ...
    global.assertNoMatch = assertNoMatch;
    global.assertTagName = assertTagName;
    global.assertClassName = assertClassName;
    global.assertElementId = assertElementId;
    global.assertInstanceOf = assertInstanceOf;
}
